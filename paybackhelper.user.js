...
(function () {
  ...
  sleep(2000).then(() => {
    ...
    span.innerHTML =
      '<input type="button" href="javascript:void(0);" style="margin-left: 6px; padding: 8px;" title="Alle Coupons aktivieren" value="Alle Coupons aktivieren">';
        ...
        coupons.forEach((coupon) => {
          try {
            coupon.shadowRoot
              ...
              .shadowRoot.querySelector("button.not-activated")
              .click();
          } catch (error) {
            console.error(error);
          }
    ...
    document
      .querySelector("#coupon-center")
      .shadowRoot.querySelector("div.coupon-center__filter")
      .append(span);
  });
})();
